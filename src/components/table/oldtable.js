  ...
  const visibleRows = useMemo(
    ...
    const theme = useTheme();
      ...
      const sendStatus = (param) => {
        ...
        return <Box sx={{ background: color ,float:'right', width:'fit-content' , color:'white' , padding:'5px' , minWidth:'100px' ,textAlign:'center' , borderRadius:'3px'}}>{param}</Box>;
      };
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{sendStatus(row.protein)}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
