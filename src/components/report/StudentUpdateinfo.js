...
const StudentUpdateinfo = (props) => {
    ...
    const [data , setData] = useState({ inputs:[
        ...
        {data: 'پخوانۍ اساس نمبر', type: 'number', value: props.info.OldAssasNo, name: 'OldAssasNo', feildtype:'input', lg: 9 , md: 9, sm: 12, xs: 12, lang:'ph'},
        ...
        {data: 'Update Student', type: 'text', required: true, name: 'Roll', feildtype:'button', lg: 12 , md: 12, sm: 12, xs: 12, lang: 'en'},
    ...
    const myfunc = async (event) => {
        ...
        await dispatch(PostRequest(api.udpateStudentReg,  JSON.parse(sessionStorage.getItem("User_Data")).token , inputValues))
        setTimeout(()=>{
